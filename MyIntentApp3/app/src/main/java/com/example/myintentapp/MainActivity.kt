    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "jamal")
                val putExtra = moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 16)
